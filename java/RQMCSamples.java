...
public class RQMCSamples extends RQMCExperiment {
   ...
   public static void simulRepsAllTypes(MonteCarloModelDoubleTag model, int s, int k, int m) throws IOException {
   ...
   // The sorted values are saved in a file for each of the 5 types.
   public static void simulRepsNUS(MonteCarloModelDoubleTag model, int s, int k, int m) throws IOException {
      TallyStore statReps;
      RandomStream stream = new LFSR113();
      String modelTag = model.getTag();
      System.out.println("RQMC replicates with model: " + model.toString() + "\n");
   ...
   // The sorted values are saved in a file for each of the 5 types.
   public static void simulRepsLMS(MonteCarloModelDoubleTag model, int s, int k, int m) throws IOException {
      TallyStore statReps;
      RandomStream stream = new LFSR113();
      String modelTag = model.getTag();
      System.out.println("RQMC replicates with model: " + model.toString() + "\n");
